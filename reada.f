...
*********************************************************************
      ...
      SUBROUTINE PARSE(STR,MAXI,MAXLEN,STRV,NF,INULL)
      INTEGER MAXI,MAXLEN,NF,INULL,IND,POS,LENGTH
      CHARACTER*(*) STR,STRV(*)

      INULL=0
      IND=1
      DO N=1,MAXI 
         CALL STRSEA(STR,MAXLEN,POS,LENGTH)
         IF(LENGTH.EQ.0) GOTO 10
         STRV(N)=STR(POS:POS+LENGTH-1)
         STR=STR(POS+LENGTH+1:)
      ENDDO
 10   CONTINUE
      IF(N.EQ.1 .AND. LENGTH.EQ.0) INULL=1
      NF=N-1
      RETURN
      END
...
********************************************************************* 
      ...
      SUBROUTINE STRSEA(STR,MAXLEN,POS,LENGTH)
      INTEGER MAXLEN,POS,LENGTH
      CHARACTER*(*) STR
